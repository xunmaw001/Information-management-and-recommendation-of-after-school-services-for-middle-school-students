...
public class KehoufuwuLiuyanView extends KehoufuwuLiuyanEntity implements Serializable {
	...
	public KehoufuwuLiuyanView() {

	}

	public KehoufuwuLiuyanView(KehoufuwuLiuyanEntity kehoufuwuLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, kehoufuwuLiuyanEntity);
